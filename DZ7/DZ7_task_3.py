...
class PublicTransport:
    ...
    def info(self):
        """
        Вывод на печать характеристики о марке, цвете, годе выпуска, мощности двигателя
        :return: Строка с характеристиками
        """
...
class Bus(PublicTransport):
    ...
    def park(self, park_bus):
        """
        Даём номер парку и проверяем, что он в диапазоне от 1000 до 9999
        :param park_bus: новый номер парка автобуса
        """
...
class Tram(PublicTransport):
    ...
    def how_long(self):
        """
        Вычисление времени на прохождение маршрута
