...
def to_roman(val):
    ...
    dictionary_roman = {"M": 1000, "CM": 900, "D": 500, "CD": 400, "C": 100, "XC": 90, "L": 50, "XL": 40, "X": 10, "IX": 9, "V": 5, "IV": 4, "I": 1}
    roman_str = ""
    for letter, value in dictionary_roman.items():
        while val >= value:
            roman_str += letter
            val -= value
    print("Римское значение:", roman_str)
    return roman_str
