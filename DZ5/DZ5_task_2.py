...
def repeats(our_str):
    """
    Функция смотрит, сколько раз каждый символ уже встречался, и добавляет количество к символам с помощью постфикса формата _n.
    :param: our_str - строка на вход
    :return: Строка из букв и их частот, разделенных _ в веденной строке our_str, в формате буква"_"количество_вождений без разделений
    """
